...
class AddSalsa extends StatefulWidget {
  const AddSalsa({super.key});

  @override
  State<AddSalsa> createState() => _AddSalsaState();
}

class _AddSalsaState extends State<AddSalsa> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();

  // HSV Color picker values
  double _hue = 0.0; // 0-360
  double _saturation = 100.0; // 0-100
  double _value = 100.0; // 0-100
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agregar Salsa'),
        actions: [
          IconButton(
            onPressed: () => _buttonSave(context),
  ...
  Future<void> _buttonSave(BuildContext context) async {
            ...
            SnackBar(
              content: Row(
                children: const [
                  ...
                  SizedBox(width: 12),
                  Text("Salsa creada exitosamente"),
                ],
              ),
